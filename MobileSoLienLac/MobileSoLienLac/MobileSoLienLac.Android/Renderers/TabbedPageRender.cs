...
using MobileSoLienLac.Droid.Renderers;
...
[assembly: ExportRenderer(typeof(NotifyPage), typeof(TabbedPageRender))]
namespace MobileSoLienLac.Droid.Renderers
{
    public class TabbedPageRender : VisualElementRenderer<NotifyPage>, IOnTabClickListener
    {
        ...
        public TabbedPageRender(Context context) : base(context)
        {
            AutoPackage = false;
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<NotifyPage> e)
        {
        ...
        private void InitializeElement(NotifyPage element)
        {
        ...
        private void ClearElement(NotifyPage element)
        {
            if (_currentPage != null)
            {
